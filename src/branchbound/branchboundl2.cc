...
void BranchBoundL2::compute_coef(std::vector<double>& phi, std::vector<double>& phi_prev, std::vector<int>& x){
    double y0Ty0 = 0;
    double y0Ty1 = 0;
...
void BranchBoundL2::compute_coef_and_compute_bound(std::vector<double>& phi, std::vector<double>& phi_prev,
